...
/**
 * Slurps in lots of JSON files from a Twitter account export, and stores them in memory in a form that's useful
 * for supplying a Markov generator with a corpus of source text.
 *
 * @author @JoeSondow
 */
public class JsonParser {
    ...
    /**
     * Go through all the js files in the directory where they're stored. Remove garbage first line of each js
     * file because that's how Twitter rolls. Collect the text of each tweet record that is not a retweet.
     *
    ...
    public List<String> parse(File folder) throws IOException, JSONException {
        ...
        for (File file : files) {
            if (file.getName().endsWith(".js")) {
                ...
                // Remove garbage first line of each js file because that's how Twitter rolls.
